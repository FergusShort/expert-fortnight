          ...
          <CardBody className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-orange-600">{expiringSoon}</span>
              </div>
        ...
        <Card>
          <CardBody className="p-6">
            <div className="flex items-start mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-1">Environmental Impact</h3>
                <p className="text-gray-600">Your contribution matters</p>
              </div>
            </div>
            
            <p className="text-gray-700 mb-4">
              By reducing food waste, you're making a significant environmental impact. Every item saved helps reduce greenhouse gas emissions and conserves resources.
            </p>
            ...
            <div className="mt-4 p-4 bg-green-50 rounded-lg">
              <p className="text-sm text-green-700">
                <strong>Did you know?</strong> The average household wastes approximately 30% of the food they purchase. By using SmartExpire, you can reduce this by up to 80%.
              </p>
            </div>
          </CardBody>
        </Card>
